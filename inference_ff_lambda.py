...
# copied onto top level on docker container image - does not work - cannot find module
# import shufflenetv2
...
#from models import shufflenetv2 # lambda error - NO module name 'modules'
import shufflenetv2 
...
def lambda_handler(event, context):
    ...
    filename = key + '.txt'
    client_s3.put_object(Body=response_str, Bucket='shufflenet-images-predictions-dsikar', Key=filename)
